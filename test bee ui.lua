...
-- ══════════════════════════════════════════
--  LUCIDE ICONS
--  These Unicode symbols render correctly in Ubuntu & Gotham fonts.
--  The "square box" issue only affects a few specific symbols (▾ ✕)
--  which we handle separately with dedicated label fonts.
-- ══════════════════════════════════════════
...
function BeeUI:CreateWindow(config)
    ...
    -- Title/SubTitle stored for font changes
...
Util.Corner(btnClose,7)
    ...
    local btnMin = Util.Button(titleBar, {
        Name="MinBtn",
        Text="−",                       -- U+2212 MINUS SIGN, renders fine in Ubuntu
    ...
    Window._fontTargets       = {}   -- all labels/buttons that follow the font picker
    ...
    local function createTabButton(parent, tabName, tabConfig, isFirst)
        ...
        if tabConfig.Icon then
            ...
            if iconInfo.type=="lucide" then
                ...
                -- Icon label always uses Ubuntu font so Unicode renders correctly
                Util.Label(tabBtn,{
    ...
    function Window:AddTab(tabConfig)
        ...
        local function makeLabel(parent, text, x, y, w, h, font, size, color)
            ...
            table.insert(Tab._window._fontTargets,lbl); return lbl
        end
    ...
    local function buildSettingsTab()
        ...
        local function sMakeRow(label,height)
            local row=Util.Frame(scrollFrame,{Name="Row_"..(label or "Item"),Size=UDim2.new(1,0,0,height or 48),BackgroundColor3=theme.SurfaceElevated})
            Util.Corner(row,10);Util.Stroke(row,theme.Border,1,0); return row
        end
        ...
        do
            ...
            -- Build dropdown manually (can't use buildDropdown since Tab context differs)
            ...
            -- Rotated ">" arrow — same fix as above
            ...
            for _,opt in ipairs(fontNames) do
                ...
                optBtn.MouseButton1Click:Connect(function()
                    ...
                    -- Apply new font to ALL targets including title/subtitle
        ...
        local accentPresets={{Name="Honey",Color=Color3.fromRGB(255,180,30)},{Name="Violet",Color=Color3.fromRGB(139,92,246)},{Name="Blue",Color=Color3.fromRGB(59,130,246)},{Name="Green",Color=Color3.fromRGB(52,211,153)},{Name="Pink",Color=Color3.fromRGB(244,114,182)},{Name="Red",Color=Color3.fromRGB(239,68,68)},{Name="Teal",Color=Color3.fromRGB(20,184,166)},{Name="Orange",Color=Color3.fromRGB(251,146,60)}}
        ...
        accentGrid.CellSize=UDim2.new(0,24,0,24);accentGrid.CellPadding=UDim2.new(0,6,0,6);accentGrid.FillDirection=Enum.FillDirection.Horizontal;accentGrid.HorizontalAlignment=Enum.HorizontalAlignment.Left;accentGrid.SortOrder=Enum.SortOrder.LayoutOrder;accentGrid.Parent=accentContainer
...
function BeeUI:Notify(config)
    ...
    -- Notification icons — use Ubuntu font, these Unicode chars render fine there
